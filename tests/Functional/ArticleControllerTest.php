...
class ArticleControllerTest extends WebTestCase
{
    ...
    {
        // On crée un client léger pour envoyer des requêtes HTTP
    ...
    public function testIndexEndPointWithNoConnectedUsere(): void
    {
    ...
    public function testIndexEndpointValideStructureJsonResponse(): void
    {
        $this->client->loginUser(
            $this->getUser(),
            'login'
    ...
    public function testIndexEndpointValidateNumberOfItemWithLimitParameter(): void
    {
        $this->client->loginUser(
            $this->getUser(),
            'login'
    ...
    public function testCreatedEndpointWithConnectedAdmin(): void
    {
        $user = $this->getUser();
    ...
    public function testCreateEndpointValidateCreationInBdd(): void
    {
        ...
        $article = self::getContainer()->get(ArticleRepository::class)
            ->findOneBy(['title' => 'Article de test']);

        $this->assertInstanceOf(Article::class, $article);
    }

    public function testUpdatedEndpointWithConnectedUser(): void
    {
        $this->client->loginUser(
            $this->getUser('user'),
            'login'
    ...
    public function testUpdatedEndpointWithNoConnectedUser(): void
    {
        $this->client->request('PATCH', '/api/admin/articles/1');
    ...
    public function testUpdatedEndpointWithConnectedAdmin(): void
    {
        $user = $this->getUser();
